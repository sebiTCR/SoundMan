...
const creation_dialogue = preload("res://addons/soundman/ui/components/text_input_dialogue/text_input_dialogue.tscn")

var _audio_entry = preload("res://addons/soundman/ui/components/audio_entry/audio_entry.tscn")
